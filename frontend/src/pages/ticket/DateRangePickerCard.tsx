    ...
    return (
        <>
            ...
            <button
                ...
                type="button"
                onClick={openPanel}
                className={`flex items-center justify-center text-xs font-semibold p-2 sm:px-3 sm:py-2 rounded-lg border transition-all min-h-[36px] flex-shrink-0 ${hasActive
